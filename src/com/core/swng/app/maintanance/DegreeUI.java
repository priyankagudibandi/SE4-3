...
public class DegreeUI extends JFrame {
	...
	public void refreshTable() {
		...
		Degree degree = null;
		for (int i = 0; i < DataManager.degreeDataBaseMap.size(); i++) {
			degree = DataManager.degreeDataBaseMap.get(i);
	...
	public void create() {
		...
		if (isValidData()) {
			int i = DataManager.degreeDataBaseMap.size();
			DataManager.degreeDataBaseMap.put(i, degree);
			refreshTable();
	...
	public void read() {
		if (getSelectedId() >= 0) {
			...
			Degree degree = DataManager.degreeDataBaseMap.get(getSelectedId());
	...
	public void update() {
		if (getSelectedId() >= 0) {
			...
			DataManager.degreeDataBaseMap.put(getSelectedId(), degree);
	...
	public void delete() {
		...
		int selectedRow = jTable.getSelectedRow();
		if (selectedRow >= 0) {
			DataManager.degreeDataBaseMap.remove(getSelectedId());
